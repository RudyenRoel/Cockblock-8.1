...
namespace CockBlock8._1.Main.Instructions
{
    ...
    public sealed partial class InstructionPage : CB_Page
    {
        ...
        private void Init()
        {
            ...
            this._Back_bn.Content = "Back";
            this._Help_bn.FontSize = Settings._DefaultButtonFontSizeTablet;
            this._Back_bn.FontSize = Settings._DefaultButtonFontSizeTablet;
        ...
        private void SetButtons()
        {
            ...
            foreach (string path in imagePaths)
            {
                ...
                button.FontSize = Settings._DefaultButtonFontSizeTablet;
        ...
        { return new Button[] { this._Help_bn, this._Back_bn, this._Close_Flyout_bn }; }
